...
<table class="table table-bordered" style="width: 600px; margin-left: 0px; margin-right: 0px;">
	<tbody>
		<tr>
...
<table border="1" cellpadding="1" cellspacing="1" class="table table-bordered" style="width: 500px; margin-left: 0px; margin-right: 0px;">
	<tbody>
		<tr>
